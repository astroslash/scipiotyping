...
The ScipioTyping library contains 185 reviewed built-in passages. The application also
...
with an average of 75.8 words. All built-in passages have reviewed
