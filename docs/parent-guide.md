...
1. Run `start-scipiotyping.ps1` and leave its PowerShell window open.
2. Kenneth can choose **Placement** under Lessons or begin with any Library item.
...
The parent PIN is household protection, not an online security boundary.
