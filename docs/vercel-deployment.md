...
- `SCIPIO_FAMILY_PASSWORD`: at least 12 characters.
- `SCIPIO_PARENT_PASSWORD`: a different password of at least 12 characters.
...
connection and the six access credentials only in the current PowerShell
window, and run:

```powershell
$env:DATABASE_URL = "postgresql://..."
$env:SECRET_KEY = "..."
$env:SCIPIO_FAMILY_PASSWORD = "..."
...
Visit the Vercel URL in a private browser window. Confirm the family password,
